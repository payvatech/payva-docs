    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          'hover:bg-brand-tertiary hover:text-white',
          'size-9 p-0 font-normal aria-selected:opacity-100'
        ),
        day_range_end: 'day-range-end',
        day_selected:
          'bg-brand-tertiary text-white hover:bg-brand-tertiary hover:text-white focus:bg-brand-tertiary focus:text-white',
        day_today: 'bg-brand-secondary text-white',
        day_outside:
      ...
      components={{
        IconLeft: () => <MdChevronLeft className="size-4" />,
        IconRight: () => <MdChevronRight className="size-4" />,
      }}
      {...props}
    />
  )
